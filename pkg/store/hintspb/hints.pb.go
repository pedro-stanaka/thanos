...
type LabelValuesRequestHints struct {
	...
	/// is applied.
	BlockMatchers []storepb.LabelMatcher `protobuf:"bytes,1,rep,name=block_matchers,json=blockMatchers,proto3" json:"block_matchers"`
	// label values deadline milliseconds
	DeadlineMilliseconds int64 `protobuf:"varint,99,opt,name=deadline_milliseconds,json=deadlineMilliseconds,proto3" json:"deadline_milliseconds,omitempty"`
}
...
var fileDescriptor_b82aa23c4c11e83f = []byte{
	...
	,
}
...
func (m *LabelValuesRequestHints) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.DeadlineMilliseconds != 0 {
		i = encodeVarintHints(dAtA, i, uint64(m.DeadlineMilliseconds))
		i--
		dAtA[i] = 0x6
		i--
		dAtA[i] = 0x98
...
func (m *LabelValuesRequestHints) Size() (n int) {
	...
	if m.DeadlineMilliseconds != 0 {
		n += 2 + sovHints(uint64(m.DeadlineMilliseconds))
	}
	return n
}
...
func (m *LabelValuesRequestHints) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 99:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DeadlineMilliseconds", wireType)
			}
			m.DeadlineMilliseconds = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowHints
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DeadlineMilliseconds |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
