...
replace (
	...
	// https://github.com/andrejbranch/prometheus/commit/908c40edf8a3384bd3830ba62137a6d5bd44b504
	github.com/prometheus/prometheus => github.com/andrejbranch/prometheus v0.0.0-20250326175854-908c40edf8a3
