...
replace (
	...
	// https://github.com/andrejbranch/prometheus/commit/bfb71f85f9e81717e959d3544a31ff78431199b1
	github.com/prometheus/prometheus => github.com/andrejbranch/prometheus v0.0.0-20250512145821-bfb71f85f9e8
